...
$connStr = "Driver={Microsoft Access Driver (*.mdb, *.accdb)};Dbq=C:\Apache24\htdocs\Git\shl-prognostics\DataCodes.accdb";    //Put in the filepath to the access database where highlighted.
